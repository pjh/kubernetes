...
# Location of the certificates file on Windows nodes. Used by
# gke-exec-auth-plugin.exe for shielded nodes.
WINDOWS_CA_FILE="${WINDOWS_PKI_DIR}\ca-certificates.crt"
