...
.EXAMPLE
  Suggested usage for dev/test:
    ...
    Invoke-WebRequest `
        https://github.com/pjh/kubernetes/raw/windows-up/cluster/gce/windows/k8s-node-setup.psm1 `
        -OutFile C:\k8s-node-setup.psm1
    Invoke-WebRequest `
        https://github.com/pjh/kubernetes/raw/windows-up/cluster/gce/windows/configure.ps1 `
...
function Create-PauseImage {
  ...
  # TODO(pjh): update this function to properly support 2019.
