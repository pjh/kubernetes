...
# Detect minions created in the minion group. Finds both Linux and Windows
# minion nodes.
#
# Assumed vars:
...
NUM_LINUX_NODES: $(yaml-quote ${NUM_LINUX_NODES})
...
function set_num_migs() {
  ...
  export NUM_MIGS=$((${NUM_LINUX_MIGS} + ${NUM_WINDOWS_MIGS}))
}
